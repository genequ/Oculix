...
import org.sikuli.ide.ui.FontUtils;
...
class SikuliIDEStatusBar extends JPanel {
  ...
  public SikuliIDEStatusBar() {
    ...
    _lblMsg = new JLabel();
    _lblMsg.setFont(FontUtils.getFallbackFont(11));

    _lblOcrStatus = new JLabel();
    _lblOcrStatus.setFont(FontUtils.getFallbackFont(11));
    checkOcrStatus();

    _lblCaretPos = new JLabel();
    _lblCaretPos.setFont(FontUtils.getFallbackFont(11));
